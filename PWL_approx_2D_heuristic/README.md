...
## Analysis
Most tables analysing the numerical results from this heuristic and the state of the art solvers are computed with functions from file ../supporting_julia_files/managing_benchmark_results.jl.
